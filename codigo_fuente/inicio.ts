...
export class Inicio implements OnInit, OnDestroy, AfterViewInit {
  ...
  ScrollTrigger.batch('.reveal', {
    ...
    onEnter: batch => gsap.to(batch, { opacity: 1, y: 0, scale: 1, duration: 0.8, stagger: 0.15, ease: "power2.out", overwrite: true }),
    onLeave: batch => gsap.to(batch, { opacity: 0, y: 60, scale: 0.96, duration: 0.5, overwrite: true }),
    onEnterBack: batch => gsap.to(batch, { opacity: 1, y: 0, scale: 1, duration: 0.8, stagger: 0.15, ease: "power2.out", overwrite: true }),
    onLeaveBack: batch => gsap.to(batch, { opacity: 0, y: 60, scale: 0.96, duration: 0.5, overwrite: true })
  });
  ...
  screens = [
    { img: 'screen1.png', text: 'Bienvenido' },
    { img: 'screen2.png', text: 'Iniciar Sesión' },
    { img: 'screen3.png', text: 'Crear Cuenta' },
    { img: 'screen4.png', text: 'Elegir Cuenta' },
    { img: 'screen5.png', text: 'Seleccionar Perfil' },
    { img: 'screen6.png', text: 'Pantalla de Inicio Para Niños' },
    { img: 'screen7.png', text: 'Pantalla de Inicio Para Padres' },
    { img: 'screen8.png', text: 'Balance Nutricional' },
    { img: 'screen9.png', text: 'Reportes y Estadísticas' },
    { img: 'screen10.png', text: 'Registrar Comidas' },
    { img: 'screen11.png', text: 'Notificaciones' }
...
async enviarMensaje(form: NgForm) {
  ...
  ngOnInit() {
    this.screensLoop = [...this.screens, ...this.screens];
  }
